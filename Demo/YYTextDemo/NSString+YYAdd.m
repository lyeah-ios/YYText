...
- (BOOL)containsEmojiForSystemVersion:(double)systemVersion {
    ...
    if ([self rangeOfCharacterFromSet:minSet8_3].location != NSNotFound) return YES;
    ...
    static NSRegularExpression *regex9_0;
    ...
    NSRange regexRange = [regex9_0 rangeOfFirstMatchInString:self options:kNilOptions range:NSMakeRange(0, self.length)];
